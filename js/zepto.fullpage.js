...
(function($, window, undefined) {
    ...
    function Fullpage($this, option, cb) {
    ...
    $.extend(Fullpage.prototype, {
        ...
        initEvent: function(cb) {
            ...
            $this.on('touchend', function(e) {
                ...
                that.moveTo(that.curIndex + der, true, cb);
            });
            if (that.o.drag) {
        ...
        moveTo: function(next, anim, cb) {
            ...
            window.setTimeout(function() {
                ...
                if (next !== cur) {
                    ...
                    if(cb instanceof Function) cb(next);
                }
            }, that.o.duration);
    ...
    $.fn.fullpage = function(option, cb) {
        if (!fullpage) {
            fullpage = new Fullpage($(this), option, cb);
        }
        return this;
    };
